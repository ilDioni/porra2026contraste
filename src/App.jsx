...
const KO_MATCHES = [
  // Dieciseisavos (orden cronológico). home/away según cuadro oficial.
  { id:"M73",  round:"r32",   ko:"2026-06-28T19:00:00+02:00", home:{type:"runner",group:"A"}, away:{type:"runner",group:"B"} },
  { id:"M76",  round:"r32",   ko:"2026-06-29T17:00:00+02:00", home:{type:"winner",group:"C"}, away:{type:"runner",group:"F"} },
  { id:"M74",  round:"r32",   ko:"2026-06-29T20:30:00+02:00", home:{type:"winner",group:"E"}, away:{type:"third",groups:["A","B","C","D","F"]} },
  { id:"M75",  round:"r32",   ko:"2026-06-30T01:00:00+02:00", home:{type:"winner",group:"F"}, away:{type:"runner",group:"C"} },
  { id:"M78",  round:"r32",   ko:"2026-06-30T17:00:00+02:00", home:{type:"runner",group:"E"}, away:{type:"runner",group:"I"} },
  { id:"M77",  round:"r32",   ko:"2026-06-30T21:00:00+02:00", home:{type:"winner",group:"I"}, away:{type:"third",groups:["C","D","F","G","H"]} },
  { id:"M79",  round:"r32",   ko:"2026-07-01T01:00:00+02:00", home:{type:"winner",group:"A"}, away:{type:"third",groups:["C","E","F","H","I"]} },
  { id:"M80",  round:"r32",   ko:"2026-07-01T16:00:00+02:00", home:{type:"winner",group:"L"}, away:{type:"third",groups:["E","H","I","J","K"]} },
  { id:"M82",  round:"r32",   ko:"2026-07-01T20:00:00+02:00", home:{type:"winner",group:"G"}, away:{type:"third",groups:["A","E","H","I","J"]} },
  { id:"M81",  round:"r32",   ko:"2026-07-02T00:00:00+02:00", home:{type:"winner",group:"D"}, away:{type:"third",groups:["B","E","F","I","J"]} },
  { id:"M84",  round:"r32",   ko:"2026-07-02T19:00:00+02:00", home:{type:"winner",group:"H"}, away:{type:"runner",group:"J"} },
  { id:"M83",  round:"r32",   ko:"2026-07-02T23:00:00+02:00", home:{type:"runner",group:"K"}, away:{type:"runner",group:"L"} },
  { id:"M85",  round:"r32",   ko:"2026-07-03T03:00:00+02:00", home:{type:"winner",group:"B"}, away:{type:"third",groups:["E","F","G","I","J"]} },
  { id:"M88",  round:"r32",   ko:"2026-07-03T18:00:00+02:00", home:{type:"runner",group:"D"}, away:{type:"runner",group:"G"} },
  { id:"M86",  round:"r32",   ko:"2026-07-03T22:00:00+02:00", home:{type:"winner",group:"J"}, away:{type:"runner",group:"H"} },
  { id:"M87",  round:"r32",   ko:"2026-07-04T01:30:00+02:00", home:{type:"winner",group:"K"}, away:{type:"third",groups:["D","E","I","J","L"]} },
  // Octavos (ganadores de dieciseisavos)
  { id:"M89",  round:"r16",   ko:"2026-07-04T17:00:00+02:00", home:{type:"wmatch",match:"M73"}, away:{type:"wmatch",match:"M75"} },
  { id:"M90",  round:"r16",   ko:"2026-07-04T21:00:00+02:00", home:{type:"wmatch",match:"M74"}, away:{type:"wmatch",match:"M77"} },
  { id:"M91",  round:"r16",   ko:"2026-07-05T20:00:00+02:00", home:{type:"wmatch",match:"M76"}, away:{type:"wmatch",match:"M78"} },
  { id:"M92",  round:"r16",   ko:"2026-07-06T00:00:00+02:00", home:{type:"wmatch",match:"M79"}, away:{type:"wmatch",match:"M80"} },
  { id:"M93",  round:"r16",   ko:"2026-07-06T19:00:00+02:00", home:{type:"wmatch",match:"M83"}, away:{type:"wmatch",match:"M84"} },
  { id:"M94",  round:"r16",   ko:"2026-07-07T00:00:00+02:00", home:{type:"wmatch",match:"M81"}, away:{type:"wmatch",match:"M82"} },
  { id:"M95",  round:"r16",   ko:"2026-07-07T16:00:00+02:00", home:{type:"wmatch",match:"M86"}, away:{type:"wmatch",match:"M88"} },
  { id:"M96",  round:"r16",   ko:"2026-07-07T20:00:00+02:00", home:{type:"wmatch",match:"M85"}, away:{type:"wmatch",match:"M87"} },
  // Cuartos
  { id:"M97",  round:"qf",    ko:"2026-07-09T20:00:00+02:00", home:{type:"wmatch",match:"M89"}, away:{type:"wmatch",match:"M90"} },
  { id:"M98",  round:"qf",    ko:"2026-07-10T19:00:00+02:00", home:{type:"wmatch",match:"M93"}, away:{type:"wmatch",match:"M94"} },
  { id:"M99",  round:"qf",    ko:"2026-07-11T21:00:00+02:00", home:{type:"wmatch",match:"M91"}, away:{type:"wmatch",match:"M92"} },
  { id:"M100", round:"qf",    ko:"2026-07-12T01:00:00+02:00", home:{type:"wmatch",match:"M95"}, away:{type:"wmatch",match:"M96"} },
  // Semifinales
  { id:"M101", round:"sf",    ko:"2026-07-14T19:00:00+02:00", home:{type:"wmatch",match:"M97"}, away:{type:"wmatch",match:"M98"} },
  { id:"M102", round:"sf",    ko:"2026-07-15T19:00:00+02:00", home:{type:"wmatch",match:"M99"}, away:{type:"wmatch",match:"M100"} },
  // Tercer puesto (perdedores de semifinales)
  { id:"M103", round:"third", ko:"2026-07-18T21:00:00+02:00", home:{type:"lmatch",match:"M101"}, away:{type:"lmatch",match:"M102"} },
  // Final
  { id:"M104", round:"final", ko:"2026-07-19T19:00:00+02:00", home:{type:"wmatch",match:"M101"}, away:{type:"wmatch",match:"M102"} },
];
...
function computeKnockoutTeams(results, standings, thirdAssign) {
  ...
  const resolve = (slot, mid) => {
    if (!slot) return null;
    switch (slot.type) {
      case "winner": return standings?.[slot.group]?.rows?.[0]?.code ?? null;
      case "runner": return standings?.[slot.group]?.rows?.[1]?.code ?? null;
      case "third": { const g = thirdAssign?.[mid]; return g ? (standings?.[g]?.rows?.[2]?.code ?? null) : null; }
...
function AnswersView({ profiles, allPicks, results, config, now, loading, onRefresh }) {
  ...
  const koTeams = useMemo(() => computeKnockoutTeams(results, standings, thirdAssign), [results, standings, thirdAssign]);
...
function PorraView({ picks, setPick, setChampion, setScorer, setKoPick, results, config, locked, now, timeLocked, profiles, allPicks }) {
  ...
  const thirds = useMemo(() => rankThirds(standings), [standings]);
  const thirdAssign = useMemo(() => assignThirdsToSlots(thirds.slice(0, 8).map((t) => t.group)), [thirds]);
  const teams = useMemo(() => computeKnockoutTeams(results, standings, thirdAssign), [results, standings, thirdAssign]);
...
function AdminView({ config, setConfig, results, saveResults, locked, setLocked, timeLocked, profiles, allPicks, savePicksFor, resetPassword, deleteProfile, onRefresh }) {
  ...
  const adminKoTeams = useMemo(() => computeKnockoutTeams(results, adminStandings, adminThirdAssign), [results, adminStandings, adminThirdAssign]);
